...
//---------------------------------------------------------------------------------------------------
	...
	*/
	private function InitDebugNet takes nothing returns nothing
		...
		call TriggerAddAction(t,function TestTime)

		set t = CreateTrigger()
		call TriggerRegisterPlayerChatEvent(t,Player(0),"c",true)
		call TriggerAddAction(t,function ShowTime)
		...
		set t = CreateTrigger()
		call TriggerRegisterPlayerChatEvent(t,Player(0),"e",true)
		call TriggerAddAction(t,function SetHanxin)
