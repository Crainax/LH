...
constant integer kSaveHeroTimes=11
...
boolean Yanmie__BShijieWudi= false
...
function sc___prototype30_execute takes integer i,unit a1 returns nothing
    set f__arg_unit1=a1

    call TriggerExecute(st___prototype30[i])
endfunction
function sc___prototype30_evaluate takes integer i,unit a1 returns nothing
    set f__arg_unit1=a1
...
//processed:     function interface AfterSucceed takes nothing returns nothing
  ...
  function s__Questions_succeed takes integer this returns nothing
        	...
        	if ( s__Questions_as[this] != 0 ) then
                call TriggerExecute(st___prototype37[(s__Questions_as[this])]) // INLINED!!
        	endif
			call sc__Questions_deallocate(this)
  endfunction
   ...
   local integer this= sc__MultiLife__staticgetindex(GetExpiredTimer())
			...
			if not ( IsUnitAliveBJ(s__MultiLife_caster[this]) ) then
				...
				if ( s__MultiLife_al[this] != 0 ) then
					call sc___prototype30_execute(s__MultiLife_al[this],s__MultiLife_caster[this])
				endif
			endif
  endfunction
...
//---------------------------------------------------------------------------------------------------
 ...
 function CreateLoginDialog takes player p returns nothing
        local dialog d= DialogCreate()
        local string s= "\n        	连续登录奖励\n\n        	你获得了第" + I2S(IConDays[GetConvertedPlayerId(p)]) + "天对应的" + I2S(Continous__GetGoldReward(IConDays[GetConvertedPlayerId(p)])) + "金币!\n        	明天继续签到可以获得" + I2S(Continous__GetGoldReward(IConDays[GetConvertedPlayerId(p)] + 1)) + "的金币!\n\n        	\n        	"
        local integer i= 1
        loop
        	exitwhen i > 26
...
//---------------------------------------------------------------------------------------------------
 ...
 function IsSeyuSpin1 takes player p returns boolean
		return ( not ( BCancelSpin[GetConvertedPlayerId(p)] ) ) and ( (GetBit(spin[GetConvertedPlayerId((p))] , 2) > 0) or (Jizi__IsHasWord((p) , 15)) ) // INLINED!!
		//return true
	endfunction
//---------------------------------------------------------------------------------------------------
	
 function IsXiaoyueSpin1 takes player p returns boolean
		return ( not ( BCancelSpin[GetConvertedPlayerId(p)] ) ) and ( (GetBit(spin[GetConvertedPlayerId((p))] , 3) > 0) or (Jizi__IsHasWord((p) , 15)) ) // INLINED!!
		//return true
	endfunction
...
//---------------------------------------------------------------------------------------------------
 ...
 function IsYanmieSpin1 takes player p returns boolean
		return ( not ( BCancelSpin[GetConvertedPlayerId(p)] ) ) and ( (GetBit(spin[GetConvertedPlayerId((p))] , 4) > 0) or (Jizi__IsHasWord((p) , 15)) ) // INLINED!!
		//return true
	endfunction
//---------------------------------------------------------------------------------------------------
	
 function IsXuanxueSpin1 takes player p returns boolean
		return ( not ( BCancelSpin[GetConvertedPlayerId(p)] ) ) and ( (GetBit(spin[GetConvertedPlayerId((p))] , 5) > 0) or (Jizi__IsHasWord((p) , 15)) ) // INLINED!!
		//return true
	endfunction
//---------------------------------------------------------------------------------------------------
	
 function IsTaiyaSpin1 takes player p returns boolean
		return ( not ( BCancelSpin[GetConvertedPlayerId(p)] ) ) and ( (GetBit(spin[GetConvertedPlayerId((p))] , 6) > 0) or (Jizi__IsHasWord((p) , 15)) ) // INLINED!!
		//return true
	endfunction
...
//---------------------------------------------------------------------------------------------------
 ...
 function IsHanshangSpin1 takes player p returns boolean
		return ( not ( BCancelSpin[GetConvertedPlayerId(p)] ) ) and ( (GetBit(spin[GetConvertedPlayerId((p))] , 8) > 0) or (Jizi__IsHasWord((p) , 15)) ) // INLINED!!
		//return true
	endfunction
...
//---------------------------------------------------------------------------------------------------
 ...
 function IsChenjiSpin1 takes player p returns boolean
		return ( not ( BCancelSpin[GetConvertedPlayerId(p)] ) ) and ( (GetBit(spin[GetConvertedPlayerId((p))] , 7) > 0) or (Jizi__IsHasWord((p) , 15)) ) // INLINED!!
		//return true
	endfunction
//---------------------------------------------------------------------------------------------------
	
 function IsChenjiSpin2 takes player p returns boolean
		return ( not ( BCancelSpin[GetConvertedPlayerId(p)] ) ) and ( (GetBit(spin[GetConvertedPlayerId((p))] , 10) > 0) or (Jizi__IsHasWord((p) , 15)) ) // INLINED!!
		//return true
	endfunction
//---------------------------------------------------------------------------------------------------
	
 function IsLingxueSpin1 takes player p returns boolean
		return ( not ( BCancelSpin[GetConvertedPlayerId(p)] ) ) and ( (GetBit(spin[GetConvertedPlayerId((p))] , 9) > 0) or (Jizi__IsHasWord((p) , 15)) ) // INLINED!!
		//return true
	endfunction
...
//---------------------------------------------------------------------------------------------------
 ...
 function IsMoqiSpin1 takes player p returns boolean
		return ( not ( BCancelSpin[GetConvertedPlayerId(p)] ) ) and ( (GetBit(spin2[GetConvertedPlayerId((p))] , 1) > 0) or (Jizi__IsHasWord((p) , 15)) ) // INLINED!!
		//return true
	endfunction
//---------------------------------------------------------------------------------------------------
	
 function IsKaisaSpin1 takes player p returns boolean
		return ( not ( BCancelSpin[GetConvertedPlayerId(p)] ) ) and ( (GetBit(spin2[GetConvertedPlayerId((p))] , 2) > 0) or (Jizi__IsHasWord((p) , 15)) ) // INLINED!!
		//return true
	endfunction
...
//---------------------------------------------------------------------------------------------------
 ...
 function IsXuanxueSpin2 takes player p returns boolean
		return ( not ( BCancelSpin[GetConvertedPlayerId(p)] ) ) and ( (GetBit(spin2[GetConvertedPlayerId((p))] , 3) > 0) or (Jizi__IsHasWord((p) , 15)) ) // INLINED!!
		//return true
	endfunction
//---------------------------------------------------------------------------------------------------
	
 function IsBajueSpin1 takes player p returns boolean
		return ( not ( BCancelSpin[GetConvertedPlayerId(p)] ) ) and ( (GetBit(spin2[GetConvertedPlayerId((p))] , 5) > 0) or (Jizi__IsHasWord((p) , 15)) ) // INLINED!!
		//return true
	endfunction
//---------------------------------------------------------------------------------------------------
	
 function IsSheyanSpin1 takes player p returns boolean
		return ( not ( BCancelSpin[GetConvertedPlayerId(p)] ) ) and ( (GetBit(spin2[GetConvertedPlayerId((p))] , 4) > 0) or (Jizi__IsHasWord((p) , 15)) ) // INLINED!!
		//return true
	endfunction
//---------------------------------------------------------------------------------------------------
	
 function IsHuanyiSpin1 takes player p returns boolean
		return ( not ( BCancelSpin[GetConvertedPlayerId(p)] ) ) and ( (GetBit(spin2[GetConvertedPlayerId((p))] , 6) > 0) or (Jizi__IsHasWord((p) , 15)) ) // INLINED!!
		//return true
	endfunction
//---------------------------------------------------------------------------------------------------
	
 function IsSichenSpin1 takes player p returns boolean
		return ( not ( BCancelSpin[GetConvertedPlayerId(p)] ) ) and ( (GetBit(spin2[GetConvertedPlayerId((p))] , 7) > 0) or (Jizi__IsHasWord((p) , 15)) ) // INLINED!!
		//return true
	endfunction
//---------------------------------------------------------------------------------------------------
	
 function IsCanglingSpin1 takes player p returns boolean
		return ( not ( BCancelSpin[GetConvertedPlayerId(p)] ) ) and ( (GetBit(spin2[GetConvertedPlayerId((p))] , 8) > 0) or (Jizi__IsHasWord((p) , 15)) ) // INLINED!!
		//return true
	endfunction
//---------------------------------------------------------------------------------------------------
	
 function IsHeiyanSpin1 takes player p returns boolean
		return ( not ( BCancelSpin[GetConvertedPlayerId(p)] ) ) and ( (GetBit(spin2[GetConvertedPlayerId((p))] , 9) > 0) or (Jizi__IsHasWord((p) , 15)) ) // INLINED!!
		//return true
	endfunction
//---------------------------------------------------------------------------------------------------
	
 function IsLichiSpin1 takes player p returns boolean
		return ( not ( BCancelSpin[GetConvertedPlayerId(p)] ) ) and ( (GetBit(spin2[GetConvertedPlayerId((p))] , 10) > 0) or (Jizi__IsHasWord((p) , 15)) ) // INLINED!!
		//return true
	endfunction
...
//---------------------------------------------------------------------------------------------------
 ...
 function Yanmie__CreateEffect1 takes real x,real y returns nothing
  local integer i= 1
	    call CreateUnitEffectSpecifyTime((GetOwningPlayer(yanmie) ) , ( 'h00C' ) , (( x )*1.0) , (( y )*1.0) , (( 0)*1.0) , 5) // INLINED!!
		call DestroyEffect(AddSpecialEffect("Abilities\\Spells\\Human\\Thunderclap\\ThunderClapCaster.mdl", x, y))
		loop
			exitwhen i > 6
			call DestroyEffect(AddSpecialEffect("Abilities\\Spells\\Human\\Thunderclap\\ThunderClapCaster.mdl", (RMinBJ(RMaxBJ(((x + 600 * CosBJ(i * 60))*1.0), yd_MapMinX), yd_MapMaxX)), (RMinBJ(RMaxBJ(((y + 600 * SinBJ(i * 60))*1.0), yd_MapMinY), yd_MapMaxY)))) // INLINED!!
	   		call CreateUnitEffectSpecifyTime((GetOwningPlayer(yanmie) ) , ( 'h00C' ) , (( (RMinBJ(RMaxBJ(((x + 600 * CosBJ(i * 60))*1.0), yd_MapMinX), yd_MapMaxX)) )*1.0) , (( (RMinBJ(RMaxBJ(((y + 600 * SinBJ(i * 60))*1.0), yd_MapMinY), yd_MapMaxY)) )*1.0) , (( 0)*1.0) , 5) // INLINED!!
 ...
 function CountYanmieLingyu takes nothing returns nothing
		if ( BJuexing2[GetConvertedPlayerId(GetOwningPlayer(yanmie))] ) then
			...
			if ( Yanmie__Ilingyu >= 30 ) then
	   			call CreateTextTagA(("雷神领域" ) , ( yanmie ) , (( 0 )*1.0) , (( 50 )*1.0) , (( 100 )*1.0) , (( 2)*1.0) , 16) // INLINED!!
		...
		if ( BJuexing3[GetConvertedPlayerId(GetOwningPlayer(yanmie))] ) then
			...
			if ( Yanmie__Ishuaxinyifu >= 200 ) then
	   			call CreateTextTagA(("雷神免疫" ) , ( yanmie ) , (( 50 )*1.0) , (( 0 )*1.0) , (( 100 )*1.0) , (( 2)*1.0) , 16) // INLINED!!
...
//---------------------------------------------------------------------------------------------------
 ...
 function LeishenZhisu takes nothing returns nothing
  ...
  local real y= GetUnitY(yanmie)
		call PrintSpellAdd((GetOwningPlayer(yanmie) ) , ( GetAbilityName('AEev') ) , (( damage)*1.0) , "") // INLINED!!
		call DamageArea(yanmie , GetUnitX(yanmie) , GetUnitY(yanmie) , 1800 , damage * 0.2)
		call DisableTrigger(GetTriggeringTrigger())

		loop
			exitwhen i > 6
			call DestroyEffect(AddSpecialEffect("war3mapImported\\OrbitalRay.mdx", (RMinBJ(RMaxBJ(((x + 300 * CosBJ(i * 60))*1.0), yd_MapMinX), yd_MapMaxX)), (RMinBJ(RMaxBJ(((y + 300 * SinBJ(i * 60))*1.0), yd_MapMinY), yd_MapMaxY)))) // INLINED!!
		endloop

		set i=1
		loop
			exitwhen i > 12
			call DestroyEffect(AddSpecialEffect("war3mapImported\\OrbitalRay.mdx", (RMinBJ(RMaxBJ(((x + 900 * CosBJ(i * 30))*1.0), yd_MapMinX), yd_MapMaxX)), (RMinBJ(RMaxBJ(((y + 900 * SinBJ(i * 30))*1.0), yd_MapMinY), yd_MapMaxY)))) // INLINED!!
		endloop

		set i=1
		loop
			exitwhen i > 18
			call DestroyEffect(AddSpecialEffect("war3mapImported\\OrbitalRay.mdx", (RMinBJ(RMaxBJ(((x + 1500 * CosBJ(i * 20))*1.0), yd_MapMinX), yd_MapMaxX)), (RMinBJ(RMaxBJ(((y + 1500 * SinBJ(i * 20))*1.0), yd_MapMinY), yd_MapMaxY)))) // INLINED!!
		endloop
		call PolledWait(5)
...
//---------------------------------------------------------------------------------------------------
 ...
 function BoltShadow takes real x,real y returns nothing
  local unit u
		if not ( (GetPlayerTechCountSimple('R008', GetOwningPlayer((yanmie))) == 1) and GetUnitAbilityLevel(yanmie, 'AHab') == 1 and GetUnitState(yanmie, UNIT_STATE_MANA) >= 600 ) then // INLINED!!
				return
			endif
 ...
 function SimulateDeathYanmie takes unit u returns nothing
		...
		elseif ( GetUnitTypeId(u) == 'h02M' and GetUnitUserData(u) == 1 ) then
			...
			if ( Yanmie__IYingyue >= 10 and Yanmie__UShijie != null ) then
				...
				call DamageArea(yanmie , GetUnitX(Yanmie__UShijie) , GetUnitY(Yanmie__UShijie) , 1800 , GetDamageAgi(yanmie) * 1.5)
 ...
 function Leishenzhinu takes nothing returns nothing
  local real time= GetUnitDistance(yanmie , GetAttacker())
		...
		if ( time >= 1800 ) then
 		...
 		call SimulateSpell(yanmie , GetAttacker() , 'A0N8' , 1 , 5 , "clusterrockets" , true , false , false)
 		call PolledWait(time / 1200)
		call DamageArea(yanmie , GetUnitX(yanmie) , GetUnitY(yanmie) , 300 , GetDamageAgi(yanmie) * 0.2)
		call PolledWait(5)
		call PolledWait(1)
		call EnableTrigger(GetTriggeringTrigger())
	endfunction
//---------------------------------------------------------------------------------------------------
 ...
 function Yanmie__LeishenyueyingTimer takes nothing returns nothing
  ...
  local unit u= null
		...
		if ( ModuloInteger(i, 3) == 0 ) then
			set u=CreateUnit(GetOwningPlayer(GetSpellAbilityUnit()), 'h02M', GetUnitX(yanmie), GetUnitY(yanmie), GetUnitFacing(yanmie))
		...
		if ( Yanmie__UShijie != null ) then
			if ( GetUnitDistance(Yanmie__UShijie , yanmie) > 1200 ) then
				if ( Yanmie__BShijieWudi ) then
					call UnitRemoveAbility(yanmie, 'Avul')
					set Yanmie__BShijieWudi=false
				endif
			else
				call UnitAddAbility(yanmie, 'Avul')
				set Yanmie__BShijieWudi=true
				if ( u != null ) then
...
//---------------------------------------------------------------------------------------------------
 ...
 function Yanmie__Leishenshijie takes nothing returns nothing
  local integer i= GetHeroLevel(xinglong)
		set Yanmie__UShijie=CreateUnit(GetOwningPlayer(yanmie), 'h02N', GetUnitX(yanmie), GetUnitY(yanmie), 0)
		call UnitApplyTimedLifeBJ(15, 'BHwe', Yanmie__UShijie)
        call PlaySoundBJ(gg_snd_yanmie_5)
		call PrintSpellContent((GetOwningPlayer(yanmie) ) , ( GetAbilityName(GetSpellAbilityId())) , "") // INLINED!!
...
//---------------------------------------------------------------------------------------------------
 ...
 function Yanmie__Leishenhongming takes nothing returns nothing
  local real x= Yanmie__RHongmingX + GetRandomReal(- 900, 900)
  local real y= Yanmie__RHongmingY + GetRandomReal(- 900, 900)
...
//---------------------------------------------------------------------------------------------------
 ...
 function Yanmie__TSpellYanmieAct takes nothing returns nothing
		if ( GetSpellAbilityId() == 'AHbz' ) then
		    ...
		    call TimerStart(Yanmie__THongming, 1, true, function Yanmie__Leishenhongming)
		    call PlaySoundBJ(gg_snd_yanmie_5)
	        call PrintSpellContent((GetOwningPlayer(yanmie) ) , ( GetAbilityName(GetSpellAbilityId())) , "") // INLINED!!
 ...
 function LearnSkillYanmieI takes unit learner,integer whichSpell returns nothing
  local integer i
		if ( learner == yanmie ) then
			...
			if ( whichSpell == 2 and (GetPlayerTechCountSimple('R006', GetOwningPlayer((yanmie))) == 1) and ( GetUnitAbilityLevel(yanmie, 'AEev') == 1 ) ) then // INLINED!!
				//技能2初始化
			    set Yanmie__TSpellYanmie2=CreateTrigger()
			    call DisableTrigger(Yanmie__TSpellYanmie2)
			...
			elseif ( whichSpell == 2 and (GetPlayerTechCountSimple('R006', GetOwningPlayer((yanmie))) == 1) and ( GetUnitAbilityLevel(yanmie, 'A0NA') == 1 ) ) then // INLINED!!
				//技能2(反)初始化
			    set Yanmie__TSpellYanmie2=CreateTrigger()
			    call DisableTrigger(Yanmie__TSpellYanmie2)
			    call TriggerRegisterAnyUnitEventBJ(Yanmie__TSpellYanmie2, EVENT_PLAYER_UNIT_ATTACKED)
			...
			elseif ( whichSpell == 3 and (GetPlayerTechCountSimple('R007', GetOwningPlayer((yanmie))) == 1) and GetUnitAbilityLevel(yanmie, 'AHbh') == 1 ) then // INLINED!!
				//技能3初始化
				call AddSpecialEffectTargetUnitBJ("origin", yanmie, "war3mapImported\\etherealaura.mdx")
				call InitYanmieAura()
			elseif ( whichSpell == 4 and (GetPlayerTechCountSimple('R008', GetOwningPlayer((yanmie))) == 1) and GetUnitAbilityLevel(yanmie, 'AHab') == 1 ) then // INLINED!!
				//技能4初始化
				set Yanmie__GShadow=CreateGroup()
			elseif ( whichSpell == 4 and (GetPlayerTechCountSimple('R008', GetOwningPlayer((yanmie))) == 1) and GetUnitAbilityLevel(yanmie, 'A0NB') == 1 ) then // INLINED!!
				//技能4初始化
			endif
		endif
	endfunction
...
//---------------------------------------------------------------------------------------------------
 ...
 function InitYanmie takes unit u returns nothing
	    ...
	    call TriggerRegisterUnitEvent(Yanmie__TSpellYanmie, u, EVENT_UNIT_SPELL_EFFECT)
...
call ExecuteFunc("jasshelper__initstructs53000843")
...
function jasshelper__initstructs53000843 takes nothing returns nothing
